...
class ICLEVRLayoutDataset(Dataset):
    def __init__(self, cache_text_path="/users/jason wu/downloads/GeNeVA-v1/i-CLEVR/cache_text/", cache_scene_path="/users/jason wu/downloads/GeNeVA-v1/i-CLEVR/cache_scenes/", max_seq_len=5, split="test"):
